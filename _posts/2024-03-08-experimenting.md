...
In this notebook, we understand backpropogation using elementary arithmetic operations following [[1]](#ref-1). We recommend visiting micrograd on github [[2]](#ref-2). We used $\texttt{nbconvert}$ on our notebook, also available on github [[3]](#ref-3).
