...
<figure style="text-align: center; width:100%;">
    <img src="{{site.baseurl}}/images/transformer-full-model.png" alt="transformer" style="max-width:50%; 
    height: auto; margin:3% auto; display:block;">
    <!-- <figcaption></figcaption> -->
</figure>

|:--:|
|The transformer architecture [[source](https://vaclavkosar.com/ml/transformers-self-attention-mechanism-simplified)]|
